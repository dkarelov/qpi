...
class DailyReportScrapperService:
        ...
        *,
        ...
        while True:
            try:
                ...
                invalidated = await self._maybe_invalidate_token(shop_id=shop.shop_id, exc=exc)
                return _ShopResult(
                    processed=False,
                    failed=True,
    ...
    async def _maybe_invalidate_token(self, *, shop_id: int, exc: WbReportApiError) -> bool:
