...
- `services/bot_api/withdrawal_flow.py`: shared transport-neutral seller/buyer withdrawal request creation flow; the webhook runtime supplies role-specific account and TON validation adapters.
