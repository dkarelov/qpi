...
CREATE TABLE "public"."assignments" (
    ...
    "review_phrases" text[] NOT NULL DEFAULT '{}'::text[],
...
CREATE TABLE "public"."listings" (
    ...
    "pause_reason" text,
    "pause_source" text CONSTRAINT listings_pause_source_check CHECK (pause_source = ANY (ARRAY['manual'::text, 'scrapper_401_withdrawn'::text, 'scrapper_401_token_expired'::text, 'scrapper_401_unauthorized'::text])),
...
CREATE TABLE "public"."shops" (
    ...
    "wb_token_status_source" text CONSTRAINT shops_wb_token_status_source_check CHECK (wb_token_status_source = ANY (ARRAY['manual'::text, 'scrapper_401_withdrawn'::text, 'scrapper_401_token_expired'::text, 'scrapper_401_unauthorized'::text])),
