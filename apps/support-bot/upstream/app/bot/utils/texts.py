    ...
    def data(self) -> dict:
        ...
        return {
            "en": {
                ...
                "source": ('Source code available at <a href="https://github.com/nessshon/support-bot">GitHub</a>'),
                "user_started_bot": (
                ...
                "silent_mode_enabled": ("<b>Silent mode activated!</b> Messages will not be delivered to the user."),
                "silent_mode_disabled": ("<b>Silent mode deactivated!</b> The user will receive all messages."),
            ...
            "ru": {
                ...
                "source": ('Исходный код доступен на <a href="https://github.com/nessshon/support-bot">GitHub</a>'),
                "user_started_bot": (
                ...
                "silent_mode_enabled": ("<b>Тихий режим активирован!</b> Сообщения не будут доставлены пользователю."),
